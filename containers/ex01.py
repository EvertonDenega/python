...
class Container:
    ...
    @espacos.setter
    def espacos(selfself, novo_valor):
        self._espacos = novo_valor

    @nome.setter
    def nome(selfself, novo_valor):
        self._nome = novo_valor

class Bau(Container):

    def __init__(self):
        #chamamos o método __init__ da superclasse para inicializar o atributo espaços com valor 30
...
if __name__ == "__main__":
    ...
    try:
        ...
        mochila.adicionar_item(mapa)    #coment esta linha para nao ser exception
